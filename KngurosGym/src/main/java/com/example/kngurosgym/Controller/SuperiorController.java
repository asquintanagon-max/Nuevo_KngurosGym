...
public class SuperiorController {
    ...
    private void goToProgreso(ActionEvent event) throws IOException {
        ...
        controller.setPreviousView("/com/example/kngurosgym/superior-view.fxml");
    ...
    @FXML
    private void goToDetalleEjercicio(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/kngurosgym/detalle-ejercicio.fxml"));
        Scene scene = new Scene(loader.load());
